...
\begin{itemize}
  ...
  \item $\alpha_i$ é o efeito o i-ésimo nível do fator A, i = 1,...,$a$
  \item $\gamma_j$ é o efeito do j-ésimo nível do fator B, j = 1,...,$b$
  \item $(\alpha\gamma)_{ij}$ é o efeito da interação entres os fatores A e B
  \item $\epsilon_{ijk}$ é o erro experimental
\end{itemize}
